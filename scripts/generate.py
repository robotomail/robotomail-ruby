...
class Contract:
    ...
    def models_code(self, lang):
        out = {"node": ["// Generated by scripts/generate.py. Do not edit."],
               "python": ['"""Generated API types. Request/response keys use the wire names."""', "from __future__ import annotations", "from typing import Any, Dict, List, Optional", "from typing_extensions import TypedDict, Required, NotRequired"],
